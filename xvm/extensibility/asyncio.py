...
from xvm._utils.asyncio_utils import create_task, wait_first

from xvm._utils.logging import child_process_logging
from xvm._utils.profiling import profiler
from xvm._utils.timer import Timer
            ...
            async with background_asyncio_service(event_bus_service) as eventbus_manager:
                ...
                try:
                    ...
                    if self._boot_info.profile:
                        ...
                        # See https://github.com/ethereum/xvm/issues/1711 for more.
                        try:
                            await wait_first(
                                tasks,
