...
from xvm.events import (
    AvailableEndpointsUpdated,
    EventBusConnected,
)
from xvm.extensibility.component import (
...
class ComponentManager(Service):
    ...
    logger = logging.getLogger('xvm.extensibility.component_manager.ComponentManager')
    ...
    async def run(self) -> None:
        connection_config = ConnectionConfig.from_name(
            MAIN_EVENTBUS_ENDPOINT,
            self._boot_info.xvm_config.ipc_dir
        )
