...
from xvm.abc import VirtualMachineAPI
from xvm.chains.base import Chain
from .constants import XVM_CHAIN_ID
from xvm.rlp.headers import BlockHeader
from xvm.vm.forks import (
    XvmVM
)
from xvm import constants


XVM_VM_CONFIGURATION = (
...
class BaseXvmChain:
    ...
    chain_id: int = XVM_CHAIN_ID


XVM_GENESIS_HEADER = BlockHeader(
    block_number=0,
    bloom=0,
...
class XvmChain(BaseXvmChain, Chain):
