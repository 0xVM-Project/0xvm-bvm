...
from xvm.rpc.rlp.sedes import UninterpretedTransaction


class DefaultTransactionValidator():
    """
    The :class:`~xvm.tx_pool.validators.DefaultTransactionValidator` class is responsible to
