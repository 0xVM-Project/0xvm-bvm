...
from xvm.rpc.base import AsyncChainAPI
from xvm.rpc.exceptions import RpcError
from xvm.rpc.base import (
    BaseRPCModule,
)
from xvm.rpc.retry import (
...
class RPCServer:
    ...
    def __init__(self,
        ...
        self.chain = chain
        self.logger: ExtendedDebugLogger = get_logger('xvm.rpc.server.RPCServer')
    ...
    async def execute(self,
        ...
        """
        Delegate to :meth:`~xvm.rpc.main.RPCServer.execute_with_access_control` with
        unrestricted access.
        """
