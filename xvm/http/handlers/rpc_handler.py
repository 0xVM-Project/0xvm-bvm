...
from xvm.http.exceptions import JsonParsingException, JsonRpcCallException
from xvm.http.handlers.base import BaseHTTPHandler, response_error
...
class RPCHandler(BaseHTTPHandler):
    ...
    async def handle(execute_rpc: Callable[[Any], Any], request: web.Request) -> web.Response:
        logger = logging.getLogger('xvm.http.handlers.rpc_handler')
