...
from xvm.abc import ChainDatabaseAPI
from xvm.chains import Chain

from xvm.rpc._utils.async_dispatch import async_method
from xvm.db.async_chaindb import AsyncChainDB

from .base import AsyncChainAPI

from xvm.rpc.base import AsyncChainAPI
from ..chains.xvm import XvmChain
...
class XvmAsyncChain(AsyncChainMixin, XvmChain):
    pass